//! Synthetic pastefire server for local UI review — in-memory store, no database, no egress.
//! `main.rs` remains the only production entry point.

use std::net::SocketAddr;

use pastefire::{app, build_dev_state};

const LISTEN_ADDR: &str = "127.0.0.1:9156";
...
async fn main() {
    ...
    tracing::info!(%addr, "pastefire synthetic fixture listening");
