//! Synthetic aperture server for local UI review — in-memory store, no database, no egress.
//! `main.rs` remains the only production entry point.

use std::net::SocketAddr;

use aperture::{app, build_dev_state};

const LISTEN_ADDR: &str = "127.0.0.1:9157";
...
async fn main() {
    ...
    tracing::info!(%addr, "aperture synthetic fixture listening");
