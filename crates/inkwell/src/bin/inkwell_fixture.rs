//! Synthetic inkwell server for local UI review — in-memory store, no database, no egress.
...
const LISTEN_ADDR: &str = "127.0.0.1:9153";
...
async fn main() {
    ...
    tracing::info!(%addr, "inkwell synthetic fixture listening");
