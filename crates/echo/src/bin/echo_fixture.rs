//! Synthetic echo server for local UI review — in-memory store, no database, no egress.
...
const LISTEN_ADDR: &str = "127.0.0.1:9158";
...
async fn main() {
    ...
    tracing::info!(%addr, "echo synthetic fixture listening");
